...
class PartnerAppBar extends ConsumerStatefulWidget
  ...
  @override
  ConsumerState<PartnerAppBar> createState() => _PartnerAppBarState();

  @override
  Size get preferredSize => const Size.fromHeight(94);
}

class _PartnerAppBarState extends ConsumerState<PartnerAppBar> {
  @override
