...
class AddEditCourseModals extends ConsumerStatefulWidget {
  final CourseModel? course;

  const AddEditCourseModals({super.key, this.course});

  @override
  ConsumerState<AddEditCourseModals> createState() => _AddEditCourseModalStates();
}

class _AddEditCourseModalStates extends ConsumerState<AddEditCourseModals> {
...
class AddEditCourseModal extends StatefulWidget {
  ...
  const AddEditCourseModal({this.course, required this.onSave});
